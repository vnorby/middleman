...
module Middleman::Cli
  ...
  protected
    ...
    def execute!
      ...
      css_resources = @app.sitemap.resources.select do |resource|
        resource.ext == ".css"
      end

      Parallel.each(css_resources, :in_processes => 8) do |resource|
      ...
      Parallel.each(resources, :in_processes => 8) do |resource|
